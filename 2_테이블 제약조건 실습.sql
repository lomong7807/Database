...
#실습 2-2
INSERT INTO `User2` VALUES ('A101', '강감찬', '010-1234-1001', 25);
INSERT INTO `User2` VALUES ('A102', '이성계', '010-1234-1002', 26);
...
#실습 2-4
INSERT INTO `User3` VALUES ('B101', '이방원', '010-1234-2001', 27);
INSERT INTO `User3` (`uid`, `name`, `age`) VALUES ('B102', '정몽주', 29);
...
SELECT * FROM `Child` WHERE `pid`='p101';
...
INSERT INTO `User5` (`name`, `gender`, `addr`) VALUES ('신사임당', 2, '강릉시');

UPDATE `User5` SET `age`=47 WHERE `gender`=2;
