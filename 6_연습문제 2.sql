...
INSERT INTO `bank_customer` VALUES ('910912-2000005', '신사임당', 1, '010-12334-1005', '강원도 강릉시');
INSERT INTO `bank_customer` VALUES ('941127-1000006', '이순신', 1, '010-1234-1006', '부산시 영도구');

INSERT INTO `bank_account` VALUES ('101-11-1001', 51, '자유저축예금', '730423-1000001', 420000, '2005-07-21');
INSERT INTO `bank_account` VALUES ('101-11-1003', 51, '자유저축예금', '870830-1000004', 53000, '2007-02-17');
INSERT INTO `bank_account` VALUES ('101-11-2001', 51, '자유저축예금', '220-82-52237', 23000000, '2003-04-14');
INSERT INTO `bank_account` VALUES ('101-11-2002', 51, '자유저축예금', '361-22-42687', 4201000, '2008-12-30');
INSERT INTO `bank_account` VALUES ('101-11-2003', 51, '자유저축예금', '102-22-51094', 9325010, '2010-06-07');
INSERT INTO `bank_account` VALUES ('101-12-1002', 52, '정기적립예금', '830513-2000003', 1020000, '2011-05-13');
INSERT INTO `bank_account` VALUES ('101-13-1005', 53, '주택청약예금', '941127-1000006', 720800, '2012-10-15');
...
#실습2-19
SELECT * FROM `bank_transaction` WHERE 1<=`t_dist` AND 2>=`t_dist` ORDER BY `t_dist`, `t_amount` DESC;
...
FROM `bank_transaction`
WHERE `t_dist` = 1
GROUP BY `t_a_no` ORDER BY `t_a_no` ASC;
...
GROUP BY `t_no`, `t_a_no`, `c_no`, `t_dist`, `a_item_name`, `c_name`
